...
- [garywill/tabs-at-bottom](https://github.com/garywill/tabs-at-bottom) - Firefox tabbar at bottom of window, userchrome script (runs on ff115) 🪟
...
- [n3wborn/nvim](https://github.com/n3wborn/nvim) - My own NVIM (&gt;=NVIM v0.10.0-dev-2993+gc81b7849a) lua config
...
- [jnsgruk/nixos-config](https://github.com/jnsgruk/nixos-config) - jnsgruk's NixOS configuration flake ❄️
...
- [davegallant/nix-config](https://github.com/davegallant/nix-config) - configuration for my workstations
...
- [nitin27may/mean-docker](https://github.com/nitin27may/mean-docker) - A Mean stack (Angular  17.0.3, Expressjs 4.17.1, MongoDB) jump start project with support of docker.
