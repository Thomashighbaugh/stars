...
- [nitin27may/mean-docker](https://github.com/nitin27may/mean-docker) - A Mean stack (Angular  16.2.11, Expressjs 4.17.1, MongoDB) jump start project with support of docker.
